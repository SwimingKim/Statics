...
setwd("C:/Users/SuYoung/Desktop/새 폴더/FRINFO")

#cust데이터
data<-read.csv("BGCON_FPINFO_DATA.csv")

str(data)
column<- c("CLLT_FP_PRNO",	"INCB_DVSN",	"ETRS_YM",	"FIRE_YM",	"BEFO_JOB",	"EDGB",
           "BRCH_CODE",	"SIU_CUST_YN")
